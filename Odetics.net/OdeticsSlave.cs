...
using Odetics.net.CommandBlocks.PresetSelectControl;
using Odetics.net.CommandBlocks.TransportControl;
using Sony9Pin.net;
using Sony9Pin.net.CommandBlocks;
using Sony9Pin.net.CommandBlocks.PresetSelectControl;
using Sony9Pin.net.CommandBlocks.Return;
using Sony9Pin.net.CommandBlocks.TransportControl;

namespace Odetics.net
{
    /// <summary>
    ///     The odetics slave.
    /// </summary>
    public abstract class OdeticsSlave : Sony9PinSlave
    {
        ...
        /// 
        /// </summary>
        public new event EventHandler<CueUpWithDataEventArgs> CueUpWithData = null!;

        /// <summary>
        /// 
        /// </summary>
        public new event EventHandler<InDataPresetEventArgs> InDataPreset = null!;

        /// <summary>
        /// 
        /// </summary>
        public new event EventHandler<OutDataPresetEventArgs> OutDataPreset = null!;
        ...
        /// 
        /// </summary>
        public event EventHandler EraseID = null!;
